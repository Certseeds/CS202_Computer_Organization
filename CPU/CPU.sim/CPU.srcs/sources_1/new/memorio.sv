...
assign rdata = (ioread == 1)?{16'h0000,ioread_data}:mread_data; // 可能是从memory读出，也可能自io读出，自io读取的数据是rdata的低16bit 
...
begin 
    ...
    begin 
    write_data = ((memwrite == 1'b1)?wdata:{16'b0000000000000000,wdata[15:0]});
